...
embed_path = "./data/glove.6B.200d.txt"
freeze = False
...
class Tokenizer():
    def __init__(self, datas, vocabulary=None):
        ...
        if vocabulary:
            ...
            self.tok2id = self.build_dict(self.tokenize(' '.join(datas)), offset=2)
...
if __name__ == "__main__":
    ...
    if use_pretrained_embedding:
        ...
        if use_rnn:
            ...
            model = CNN(vocab_size, embed_size, num_classes, num_filters, kernel_size, dropout_rate).to(device)
